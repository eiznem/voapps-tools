...
**Latest Version:** [v4.0.5](https://github.com/eiznem/voapps-tools/releases/latest)

**macOS:** `VoApps Tools-4.0.5-arm64.dmg`
**Windows:** `VoApps Tools Setup 4.0.5.exe`
...
#### 2. Open the DMG File
Double-click `VoApps Tools-4.0.5-arm64.dmg` in your Downloads folder
...
# Output: dist/VoApps Tools-4.0.5-arm64.dmg (macOS)
# Output: dist/VoApps Tools Setup 4.0.5.exe (Windows)
```
